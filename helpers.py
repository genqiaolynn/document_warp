...
def clockwise_order(array):
    ...
    # Output: array of 4 2-D points in clockwise order with the starting point closest to the origin
    ...
    for p in perm:
        ...
        corner3 = [[p[1][0] - p[2][0], p[1][1] - p[2][1]],
...
def order_points_clockwise(pts):
    ...
    rect[1] = pts[np.argmin(diff)]  # np.argmin --> 给出水平方向最小值的下标
...
if __name__ == '__main__':
    array = np.array([[0, 0], [618, 0], [618, 800], [0, 800]])
    order_points_clockwise_list(array)